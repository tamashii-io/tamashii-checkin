...
ActiveRecord::Schema.define(version: 2019_07_25_093638) do
  ...
  create_table "attendees", force: :cascade do |t|
    ...
    t.text "note", default: ""
    t.index ["event_id", "code"], name: "index_attendees_on_event_id_and_code", unique: true
  end
  ...
  create_table "check_points", force: :cascade do |t|
    ...
    t.string "category"
    t.index ["event_id", "category"], name: "index_check_points_on_event_id_and_category"
